...
table()
```
What is the relationship between these two variables? Who created each one?
...
```
Give a *conceptual* description of what this table is and how it was constructed. Be sure to explain what RACED is and how the table is weighted, but do not give specifics of the coding.

>

Use this week's reading to explain the patterns you see in the table to someone who has not read the article. Be sure to explain why there are so many zeros.

>

## Turn in your lab
Preview your lab to make sure all of your output and answers are included. Upload the `Lab3.nb.html` file to Canvas.